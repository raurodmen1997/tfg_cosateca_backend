...
INSERT INTO `usuarios` (`nombre`, `primer_apellido`, `segundo_apellido`, `telefono`, `direccion_email`, `cuenta_id`, `tipo_identificacion`, `codigo_identificacion`, `codigo_postal`, `olvidado`) VALUES ('Raul', 'Rodriguez', 'Mendez', '674761837', 'raulrodriguezmendez97@gmail.com', 2, 'NIF', '53346768Q', 41300, 0);
...
INSERT INTO `usuarios` (`nombre`, `primer_apellido`, `segundo_apellido`, `telefono`, `direccion_email`, `cuenta_id`, `tipo_identificacion`, `codigo_identificacion`, `codigo_postal`, `olvidado`) VALUES ('Fatima', 'Mendez', 'Bellido', '674761814', 'fatimamendez97@gmail.com', 4, 'NIF', '53346769Q', 41309, 0);
INSERT INTO `usuarios` (`nombre`, `primer_apellido`, `segundo_apellido`, `telefono`, `direccion_email`, `cuenta_id`, `tipo_identificacion`, `codigo_identificacion`, `codigo_postal`, `olvidado`) VALUES ('Antonio', 'Rodriguez', 'Ariza', '674769937', 'antoniorodriguez97@gmail.com', 5, 'NIF', '53346468Q', 41300, 0);

INSERT INTO `ayuntamientos` (`municipio`, `nombre`, `provincia`, `cuenta_id`, `direccion_email`, `telefono`, `direccion`, `codigos_postales`) VALUES ('La rinconada','Ayuntamiento de la Rinconada', 'Sevilla', 1, 'raulrodriguezmendez1997@gmail.com', '954791405', 'Plaza Juan Ramon Jimenez, 2', '41300, 41309');
