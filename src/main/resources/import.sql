...
INSERT INTO `carros_compra` (`id`) VALUES (1);
INSERT INTO `carros_compra` (`id`) VALUES (2);

INSERT INTO `usuarios` (`nombre`, `primer_apellido`, `segundo_apellido`, `telefono`, `direccion_email`, `cuenta_id`, `tipo_identificacion`, `codigo_identificacion`, `carro_compra_id`, `codigo_postal`) VALUES ('Raul', 'Rodriguez', 'Mendez', '674761837', 'raulrodriguezmendez97@gmail.com', 2, 'NIF', '53346768Q', 1, 41300);
INSERT INTO `usuarios` (`nombre`, `primer_apellido`, `segundo_apellido`, `telefono`, `direccion_email`, `cuenta_id`, `tipo_identificacion`, `codigo_identificacion`, `carro_compra_id`, `codigo_postal`) VALUES ('Andrea', 'Meca', 'Sanchez', '674761839', 'andrea.meca.sanchez@gmail.com', 3, 'NIF', '53346768Q', 2, 41300);
